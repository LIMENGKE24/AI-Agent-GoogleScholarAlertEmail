...
Please find attached the AI-generated research report (HTML format) for your recent Google Scholar alerts.

Report Date: {tag}
Keywords: {', '.join(KEYWORDS[:4])}{'...' if len(KEYWORDS) > 4 else ''}

The HTML report contains:
- Professional summary of relevant research papers
- Key insights and findings
- Five novel research ideas for future exploration
- Beautiful responsive web design for optimal viewing

Simply open the HTML file in any web browser to view the report.
